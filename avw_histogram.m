function [bins,freq,freq_nozero] = avw_histogram(avw,binInterval,binNumber)

% avw_histogram
%
% [bins,freq,freq_nozero] = avw_histogram(avw,binInterval)
%
...
% $Revision: 1.1 $ $Date: 2004/11/05 22:17:04 $
