...
G.nasion = uicontrol('Parent',GUI,'Style','text','Units','Normalized', Font, ...
    ...
    'BusyAction','queue',...
    'TooltipString','Should be toward +Y; values in meters, origin translated from center of volume to (0,0,0).',...
    'String','x,y,z');
...
G.rpa = uicontrol('Parent',GUI,'Style','text','Units','Normalized', Font, ...
    ...
    'BusyAction','queue',...
    'TooltipString','Should be toward +X; values in meters, origin translated from center of volume to (0,0,0).',...
    'String','x,y,z');
...
% Control Buttons at Bottom Right of GUI
